        ...
        <View style={styles.container}>
                ...
                <ScrollView>
                        ...
                        <TouchableOpacity>
                                    ...
                                    <Text style={styles.marketplace1}>Set a price</Text>
                        </TouchableOpacity>
                        ...
                        <View style={styles.searchRectangle}>
                            <View style={styles.contents}>
                                <View style={styles.searchIconRow}>
                                    ...
                                    <TextInput keyboardType = 'phone-pad' placeholder="Price" clearButtonMode="always" style={styles.input}></TextInput>
                                </View>
                            </View>
                        </View>
                        ...
                        <Button 
                        onPress={() => props.navigation.navigate('ProductCategoryScreen')}
                        style = {styles.Button}>
                            <Feather 
                            style = {styles.icon2}
                            name= 'arrow-right'/>
