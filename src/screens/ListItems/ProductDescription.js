        ...
        <View style={styles.container}>
                ...
                <View style={styles.TopNav}>
                    ...
                    <TouchableOpacity style={{ justifyContent: "center", borderRadius: 20, backgroundColor: '#E6E6E6'}}
                        onPress={() => props.navigation.navigate('ProductTitleScreen')}>
                ...
                <ScrollView>
                        ...
                        <TouchableOpacity>
                                    ...
                                    <Text style={styles.marketplace1}>Tell us more about your product</Text>
                        </TouchableOpacity>
                        ...
                        <View style={styles.searchRectangle}>
                            <View style={styles.contents}>
                                    <TextInput 
                                    multiline = {true}
                                    placeholder="Description" style={styles.input}></TextInput>
                            </View>
                        </View>
