        ...
        <View style={styles.container}>
                ...
                <ScrollView>
                        ...
                        <TouchableOpacity>
                                    ...
                                    <Text style={styles.marketplace1}>Upload your images</Text>
                        </TouchableOpacity>
                        ...
                        <View style = {styles.AddPhotos}>
                            <Feather
                                ...
                                name = "plus-circle"
                            />
                            <Text style = {{fontSize: 20, fontWeight: 'bold', marginLeft: 5}}>Add Photos</Text>
                        </View>
                        ...
                        <Button 
                        onPress={() => props.navigation.navigate('FinishListingScreen')}
                        style = {styles.Button}>
                            <Feather 
                            style = {styles.icon2}
                            name= 'arrow-right'/>
